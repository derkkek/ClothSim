...
Editor::Editor(sf::RenderWindow& window)
    :editorGravity(Vector3f(0.0f, 500.0f, 0.0f)), editorConstraintsIterationCount(1), state(RUN), renderState(GEOMETRY), editButtonClicked(false), runButtonClicked(false)
